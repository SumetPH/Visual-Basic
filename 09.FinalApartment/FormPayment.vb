...
Public Class FormPayment
    ...
    Handles TextRental.TextChanged, TextWater.TextChanged, TextElectric.TextChanged, _
            TextPhone.TextChanged, TextOthers.TextChanged
    ...
    Private Sub CalTotal()
        ...
        t += CheckNumber(TextPhone.Text)
        t += CheckNumber(TextOthers.Text)
    ...
    Private Sub ReadData()
        ...
        TextPhone.DataBindings.Add("Text", bindingSrc, "Telephone")
        TextOthers.DataBindings.Add("Text", bindingSrc, "Others")
        CheckPaid.DataBindings.Add("Checked", bindingSrc, "Paid")

        CalTotal()

        If TextRental.Text = "" Then
            sql = "SELECT Rental FROM Ref"
    ...
    Private Sub ButtonSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        If count = 0 Then
            sql = "INSERT INTO Payment(" & _
                  "RoomNo, Month, Year, Rental, WaterSupply, Electricity, Telephone, Others, Paid) " & _
                  "VALUES(@room, @month, @year, @rent, @water, @electric, @phone, @other, @paid)"
        Else
            sql = "UPDATE Payment SET " & _
                  "RoomNo = @room, Month = @month, Year = @year, Rental = @rent, " & _
                  "WaterSupply = @water, Electricity = @electric, Telephone = @phone, Others = @other, Paid = @paid " & _
        ...
        command.Parameters.AddWithValue("other", TextOthers.Text)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        txt = "123/45 ซอยวัดร้าง ถนนพระราม 1 แขวงรองเมือง เขตปทุมวัน กรุงเทพ 10330 โทร. 023456789"
        ...
        txt = "4. ค่าโทรศัพท์"
        e.Graphics.DrawString(txt, fnt, black, 250, 260)
        txt = TextPhone.Text
        e.Graphics.DrawString(txt, fnt, blue, 400, 260)

        txt = "5. ค่าอื่นๆ"
        e.Graphics.DrawString(txt, fnt, black, 250, 280)
        txt = TextOthers.Text
        e.Graphics.DrawString(txt, fnt, blue, 400, 280)
